...
function wmfoundation_setup() {
	...
	add_theme_support( 'custom-background', apply_filters( 'wmfoundation_custom_background_args', array(
...
add_action( 'after_setup_theme', 'wmfoundation_setup' );
 ...
 */
function wmfoundation_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'wmfoundation_content_width', 640 );
}
add_action( 'after_setup_theme', 'wmfoundation_content_width', 0 );
 ...
 */
function wmfoundation_widgets_init() {
...
add_action( 'widgets_init', 'wmfoundation_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'wmfoundation_scripts' );
