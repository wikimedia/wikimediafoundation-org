...
<div class="social-share text-center">
	...
	<ul class="social-list color-blue <?php echo esc_attr( $args['list_class'] ); ?>">
		<li><a href="<?php echo esc_html( wmf_get_share_url( 'twitter', $args ) ); ?>"><?php wmf_show_icon( 'social-twitter' ); ?></a></li>
		<li><a href="<?php echo esc_html( wmf_get_share_url( 'facebook', $args ) ); ?>"><?php wmf_show_icon( 'social-facebook' ); ?></a></li>
	</ul>
</div>
