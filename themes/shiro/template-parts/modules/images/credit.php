...
} elseif ( is_int(stripos($license,'CC') ) & is_int(stripos($license,'BY') ) & is_int(stripos($license,'4.0') )  ) {
    $license_url = 'https://creativecommons.org/licenses/by/4.0/';
} elseif ( is_int(stripos($license,'CC') ) & is_int(stripos($license,'BY') ) & is_int(stripos($license,'3.0') )  ) {
    $license_url = 'https://creativecommons.org/licenses/by/3.0/';
} elseif ( is_int(stripos($license,'CC') ) & is_int(stripos($license,'BY') ) & is_int(stripos($license,'2.5') )  ) {
    $license_url = 'https://creativecommons.org/licenses/by/2.5/';
} elseif ( is_int(stripos($license,'CC') ) & is_int(stripos($license,'BY') ) & is_int(stripos($license,'2.0') )  ) {
