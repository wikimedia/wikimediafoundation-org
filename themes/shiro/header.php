			...
			<div class="site-main-nav flex flex-medium flex-align-center mw-980">
				...
				<div class="top-nav-buttons">
					<?php if ( ! empty( $wmf_translations ) ) : ?>
						...
						?>
						<button class="dropdown__button" data-dropdown-toggle="language-picker" aria-expanded="false">
						...
						<img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/src/svg/down.svg" alt="" class="dropdown__state">
						</button>
						<div class="dropdown" data-dropdown="language-picker" data-open="false">
