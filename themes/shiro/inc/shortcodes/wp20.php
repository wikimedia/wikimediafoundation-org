...
function wmf_movement_callback( $atts = [], $content = '' ) {
	...
	<div class="movement mod-margin-bottom">
		...
		<div class="text-affiliates mw-980">
			<p><a class="arrow-link" href="">13 Wikimedia Projects</a></p>
			<p><a class="arrow-link" href="">39 Wikimedia Chapters</a></p>
			<p><a class="arrow-link" href="">135 Wikimedia User Groups</a></p>
			<p><a class="arrow-link" href="">2 Wikimedia Thematic Organizations</a></p>
		</div>
	</div>
