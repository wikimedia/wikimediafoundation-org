		...
		<div class="movement-vis">
			<div class="main-vis">
				...
				<svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 973 483"><path d="M268.859 102l7.671 13.288h-15.343L268.859 102z" fill="#72777D"/><path d="M12.859 221l7.671 13.288H5.187L12.859 221zm77 72l7.671 13.288H82.187L89.859 293z" fill="#A2A9B1"/><path d="M221.859 321l7.671 13.288h-15.343L221.859 321z" fill="#202122"/><path d="M179.859 227l7.671 13.288h-15.343L179.859 227zm643.465 120.86l7.672 13.288h-15.343l7.671-13.288z" fill="#C8CCD1"/><path d="M866.879 412.084l7.672 13.288h-15.344l7.672-13.288zM98.859 176l7.671 13.288H91.187L98.859 176z" fill="#A2A9B1"/><path d="M368.585 339.001l7.672 13.288h-15.343l7.671-13.288zm96.706-36.91l7.672 13.288H457.62l7.671-13.288z" fill="#72777D"/><path d="M393.685 126.396l7.671 13.288h-15.343l7.672-13.288zm-84.157 119.591l7.672 13.288h-15.343l7.671-13.288z" fill="#A2A9B1"/><path d="M738.859 105l7.671 13.288h-15.343L738.859 105z" fill="#EAECF0"/><path d="M563.474 413.561l7.671 13.288h-15.343l7.672-13.288z" fill="#C8CCD1"/><path d="M483.008 395.844l7.672 13.288h-15.343l7.671-13.288z" fill="#A2A9B1"/><path d="M903.051 82.103l7.672 13.288H895.38l7.671-13.288z" fill="#72777D"/><path d="M877.952 157.401l7.672 13.288H870.28l7.672-13.288zm-301.191-13.288h11.073v11.073h-11.073z" fill="#A2A9B1"/>
					<circle title="<?php echo esc_attr( $atts['projects'][0] ) ?>" class="project-circle" cx="506.096" cy="198.9" r="11" fill="#000"/>
					<circle title="<?php echo esc_attr( $atts['projects'][1] ) ?>" class="project-circle" cx="464.922" cy="356.349" r="11" fill="#000"/>
					<circle title="<?php echo esc_attr( $atts['projects'][2] ) ?>" class="project-circle" cx="386.228" cy="278.228" r="11" fill="#000"/>
					<circle title="<?php echo esc_attr( $atts['projects'][3] ) ?>" class="project-circle" cx="555.722" cy="268.502" r="11" fill="#000"/>
					<circle title="<?php echo esc_attr( $atts['projects'][4] ) ?>" class="project-circle" cx="822.217" cy="241.188" r="11" fill="#000"/>
					<circle title="<?php echo esc_attr( $atts['projects'][5] ) ?>" class="project-circle" cx="202.228" cy="159.228" r="11" fill="#000"/>
					<circle title="<?php echo esc_attr( $atts['projects'][6] ) ?>" class="project-circle" cx="859.866" cy="306.151" r="11" fill="#000"/>
					<circle title="<?php echo esc_attr( $atts['projects'][7] ) ?>" class="project-circle" cx="680.228" cy="307.228" r="11" fill="#000"/>
					<circle title="<?php echo esc_attr( $atts['projects'][8] ) ?>" class="project-circle" cx="750.578" cy="372.226" r="11" fill="#000"/>
					<circle title="<?php echo esc_attr( $atts['projects'][9] ) ?>" class="project-circle" cx="410.295" cy="200.587" r="11" fill="#000"/>
					<circle title="<?php echo esc_attr( $atts['projects'][10] ) ?>" class="project-circle" cx="636.228" cy="237.228" r="11" fill="#000"/>
					<circle title="<?php echo esc_attr( $atts['projects'][11] ) ?>" class="project-circle" cx="938.786" cy="345.276" r="11" fill="#000"/>
					<circle title="<?php echo esc_attr( $atts['projects'][12] ) ?>" class="project-circle" cx="260.228" cy="254.228" r="11" fill="#000"/>
