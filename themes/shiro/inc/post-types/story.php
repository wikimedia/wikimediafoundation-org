...
function wmf_story_updated_messages( $messages ) {
	...
	$messages['story'] = array(
		...
		5  => isset( $_GET['revision'] ) ? sprintf( __( 'Story restored to revision from %s', 'shiro-admin' ), wp_post_revision_title( (int) $_GET['revision'], false ) ) : false, // WPCS: CSRF Input var ok.
		/* translators: %s: post permalink */
